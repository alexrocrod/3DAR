...
public class PCAdv2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Get Parameters from the main menu
    ...
    {
        //Count lines
        int numPoints = -3; // remove 1st and last 2 lines
        string line;
    ...
    void InstantiateMesh(int meshInd, int nPoints)
    {
        ...
        if (neon)
            pointGroup.GetComponent<Renderer>().material = matNeon;
        else
